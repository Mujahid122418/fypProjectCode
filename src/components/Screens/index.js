...
import costumCom from "./sideDrawerNAvigator";
    ...
    Home: {
      ...
      navigationOptions: {
        tabBarIcon: ({ tintColor, focused }) => (
          <Icon name="home" size={24} focused style={{ color: "#ff7043" }} />
        )
      }
    },
    // Cars: {
    ...
    ChatBox: {
      ...
      navigationOptions: {
        tabBarIcon: ({ tintColor }) => (
          <Icon name="comment-dots" size={24} style={{ color: "#ff7043" }} />
        )
      }
    }
  },
...
const drawerNavigator = createDrawerNavigator(
  {
    main: authStackNavigation,
    logout: LogOutButton
  },
  { initialRout: "main",
contentComponent:costumCom }
);
